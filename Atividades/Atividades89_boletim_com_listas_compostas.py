...
# duas notas de vários alunos e guarde tudo em uma lista
...
while True:
    opc = int(input('Mostras notas de qual aluno? [999 interrompe]: '))
    if opc == 999:
        print('Finalizando...')
        break
    if opc <= len(ficha) - 1:
        print(f'Notas de {ficha[0]} são {ficha[opc][1]}')
print('<<< VOLTE SEMPRE >>>')
